...
<head profile="http://gmpg.org/xfn/11">
    ...
    <title><?php echo BLOG_TITLE; ?> &raquo; Archive &raquo; <?php echo $title; ?></title>
...
<body>
    ...
    <div id="primary" class="single-post">
        <div class="inside">
            <div class="primary">
                <h1 class="title">Archive for <?php echo $title; ?></h1>
            ...
            <div class="secondary">
                ...
                <div class="featured">
                    <p>Welcome to the archives at <?php echo BLOG_TITLE; ?>. Have a look around.</p>
                </div>
            </div>
