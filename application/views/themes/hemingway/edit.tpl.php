...
<head profile="http://gmpg.org/xfn/11">
    ...
    <title><?php echo BLOG_TITLE; ?> &raquo; Editing &raquo; <?php echo $article['name']; ?></title>
...
<body>
    <?php include 'application/views/view.tpl.php'; ?>
    ...
    <div id="primary" class="single-post">
        <div class="inside">
            <form action="<?php $this->url('/blog/edit/'.$article['slug']) ;?>" method="post">
                <div class="primary">
