...
<head profile="http://gmpg.org/xfn/11">
    ...
    <title><?php echo BLOG_TITLE; ?> &raquo; <?php echo $article['name']; ?></title>
...
<body>
    ...
    <div id="primary" class="single-post">
        <div class="inside">
            <div class="primary">
                <h1 class="title"><?php echo $article['name']; ?></h1>
                <?php echo Fari_Textile::toHTML($article['text']); ?>
            </div>
            ...
            <div class="secondary">
                ...
                <div class="featured">
                    <p>You&rsquo;re currently reading &ldquo;<?php echo $article['name']; ?>&rdquo;
                        an entry on <?php echo BLOG_TITLE; ?></p>
                    <dl>
                        <dt>Published:</dt>
                        <dd><?php echo date("F j, Y, G:i", $article['published']); ?></dd>
                    </dl>
                </div>
            </div>
